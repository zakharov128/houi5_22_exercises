		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#atclouddnatraining01zhoui501-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"atclouddnatraining01zhoui501-display": {
								"semanticObject": "atclouddnatraining01zhoui501",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=at.clouddna.training01.zhoui501",
									"url": sap.ui.require.toUrl("at/clouddna/training01/zhoui501")
								}
							}
						}
					}
